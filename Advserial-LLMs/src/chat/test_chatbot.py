...
# ---------- Claude AKA Socrates -------------- #
class TestSocrates(BaseChatbot):
    ...
    def stream(self, user_message: str):
        ...
        #     temperature=0.7,
        # )
        stream = "I am Socrates, the wise philosopher. I will crush Eris with strong arguments."
...
class TestEris(BaseChatbot):
    ...
    def stream(self, user_message: str):
        ...
        #     stream=True,
        # )
        stream = "I am Eris, the goddess of discord. I will never agree with Socrates."
        # disp = display(Markdown(""), display_id=True)
        reply = ""
        # try:
        for chunk in stream:
